...
class Ui_OptionsGroup(object):
    def setupUi(self, OptionsGroup):
        ...
        self.buttonGroup = QtGui.QButtonGroup(OptionsGroup)
        ...
        self.btnManualSettings = QtGui.QPushButton(OptionsGroup)
        ...
        self.btnManualSettings.setObjectName(_fromUtf8("btnManualSettings"))
        ...
        self.chkAutoZoom = QtGui.QCheckBox(OptionsGroup)
        ...
        self.chkAddCopyright = QtGui.QCheckBox(OptionsGroup)
        self.chkAddCopyright.setObjectName(_fromUtf8("chkAddCopyright"))
        self.gridLayout.addWidget(self.chkAddCopyright, 11, 0, 1, 2)
    ...
    def retranslateUi(self, OptionsGroup):
        ...
        self.chkApplyStyles.setText(_translate("OptionsGroup", "Apply GL JSON style (if specified)", None))
        self.chkClipTiles.setText(_translate("OptionsGroup", "Clip each tile at bounds (slow)", None))
        ...
        self.btnManualSettings.setText(_translate("OptionsGroup", "Manual", None))
        ...
        self.chkAddCopyright.setText(_translate("OptionsGroup", "Add copyright to map", None))
