...
class Ui_OptionsGroup(object):
    def setupUi(self, OptionsGroup):
        ...
        self.chkAddCopyright = QtWidgets.QCheckBox(OptionsGroup)
        self.chkAddCopyright.setObjectName("chkAddCopyright")
    ...
    def retranslateUi(self, OptionsGroup):
        ...
        self.chkAddCopyright.setText(_translate("OptionsGroup", "Add copyright to map"))
